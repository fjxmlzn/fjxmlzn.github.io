...
if (typeof window !== 'undefined' && window['pdfjs-dist/build/pdf']) {
  ...
  pdfjsLib = require('https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.0.207/pdf.min.js');
}
...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = 'https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.0.207/pdf.worker.min.js';
